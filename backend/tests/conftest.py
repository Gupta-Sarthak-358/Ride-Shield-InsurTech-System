...
os.environ["ENV"] = "test"
os.environ["DATABASE_URL"] = "postgresql+asyncpg://rideshield:rideshield123@localhost:5433/rideshield_deployed_test_db"
os.environ["DATABASE_URL_SYNC"] = "postgresql://rideshield:rideshield123@localhost:5433/rideshield_deployed_test_db"
